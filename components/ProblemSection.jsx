            ...
            <div className="relative">
              ...
              <div className="relative">
                <Image
                  ...
                  style={{
                    maskImage: 'linear-gradient(to bottom, black 0%, black 25%, rgba(0,0,0,0.5) 60%, transparent 90%)',
                    WebkitMaskImage: 'linear-gradient(to bottom, black 0%, black 25%, rgba(0,0,0,0.5) 60%, transparent 90%)',
                    maskSize: '100% 100%',
